...
public class WFC_EditorCustom : Editor
{
    ...
    {
        var mapGenerator = (WaveFunctionCollapse)target;
    ...
    private void CreateFooterButtons(WaveFunctionCollapse mapGenerator)
    {
        ...
        if (showGeneratorActions)
        {
            ...
            if (mapGenerator.tiles == null || mapGenerator.tiles.Count == 0)
            {
