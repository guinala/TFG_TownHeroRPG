...
public class MapGenerator2dTilePattern : MonoBehaviour
{
    ...
    [HideInInspector] public Tile BaseTile;
    ...
    */
    ...
    void InitCells()
    {
        ...
        var tilesList = TilePatternList.SelectMany(s => s.GetTiles()).Where(t => t != null).ToList();
    ...
    private void WaveFunction()
    {
        ...
        Cell nextCellToCollapse = GetSmallerEntropy();
    ...
    private void FilterPossibleOptions(Cell cell)
    {
    ...
    private Cell GetBottomCell(int row, int col)
    {
        if (row == 0)
        {
            return null;
    ...
    private Cell GetSmallerEntropy()
    {
        Cell nextCellToCollapse = null;
    ...
    */
    ...
    public void GenerateMap()
    {
        ...
        gridCells = new Cell[dimension, dimension];
        InitCells();
        Generate = true;
